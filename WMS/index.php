...
<title>Trial Expired — Newton WMS</title>
...
<div class="auth-card" style="max-width:480px; text-align:center;">
    ...
    <p class="auth-sub" style="margin-bottom:1.5rem;">
        Your 7-day free trial of the <strong>Warehouse Management System</strong> expired on <strong><?= $expires ?></strong>.
...
<div class="modal" style="max-width:420px;">
    ...
    <div class="modal-footer">
        ...
        <a href="mailto:program@newton.com.ph?subject=Full Access Request - WMS&body=Hi Newton Dev Team,%0A%0AI would like to request full access to the Warehouse Management System demo.%0A%0AName: <?= urlencode($user['name']) ?>%0AEmail: <?= urlencode($user['email']) ?>" class="btn btn-primary">
            Send Email →
        </a>
    </div>
</div>
